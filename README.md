...
# short-bio
DevOps focado em automação, ambientes previsíveis e entrega contínua. Transformo processos manuais em pipelines e infraestrutura em código. Meu objetivo é reduzir falhas e aumentar a confiabilidade do sistema.

# signature
while(alive) { automate(); ship(); observe(); improve(); }
